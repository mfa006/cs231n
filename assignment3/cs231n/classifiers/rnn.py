...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        x, cache_c = word_embedding_forward(captions_in, W_embed)
        ...
        dh, dW_vocab, db_vocab = temporal_affine_backward(dx, cache)
        dx, dh0, dWx, dWh, db = rnn_backward(dh, cache_h)
        dcaptions = word_embedding_backward(dx, cache_c)
        dx, dw, db = affine_backward(dh0, cache0)
